...
pipeline {
	...
	triggers {
		pollSCM 'H/10 * * * *'
		upstream(upstreamProjects: "spring-data-commons/2.7.x,spring-data-cassandra/3.4.x,spring-data-couchbase/4.4.x,spring-data-elasticsearch/4.4.x," +
			"spring-data-geode/2.7.x,spring-data-jpa/2.7.x,spring-data-ldap/2.7.x,spring-data-mongodb/3.4.x,spring-data-neo4j/6.3.x,spring-data-redis/2.7.x", threshold: hudson.model.Result.SUCCESS)
	}
