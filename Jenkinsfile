...
pipeline {
	...
	triggers {
		pollSCM 'H/10 * * * *'
		upstream(upstreamProjects: "spring-data-commons/4.0.x,spring-data-cassandra/5.0.x,spring-data-couchbase/6.0.x,spring-data-elasticsearch/6.0.x," +
			"spring-data-rest/5.0.x,spring-data-jpa/4.0.x,spring-data-ldap/4.0.x,spring-data-mongodb/5.0.x,spring-data-neo4j/8.0.x,spring-data-redis/4.0.x", threshold: hudson.model.Result.SUCCESS)
	}
